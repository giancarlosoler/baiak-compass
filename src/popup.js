...
async function message(payload){const [tab]=await chrome.tabs.query({active:true,currentWindow:true});if(!tab?.id)throw Error('Abre Baiak Idle.');return chrome.tabs.sendMessage(tab.id,payload)}
...
function renderAllHunts(){const q=norm($('huntFilter')?.value),rows=(data?.lastAnalysis?.ranked||[]).filter(r=>!q||norm(r.name).includes(q)).sort((a,b)=>a.name.localeCompare(b.name));$('huntCount').textContent=rows.length;$('allHunts').classList.toggle('empty',!rows.length);$('allHunts').innerHTML=rows.map(r=>{const m=measurementFor(r.name),d=m?.calibratedDifferencePct;return`<div class="hunt-row">${logo(withHuntImage(m,r))}<div><b>${esc(r.name)}</b><small>${t('level')} ${r.level} · ${r.lean==='loot'?'Loot':'XP'}${m?` · <span class="difference inline ${diffClass(d)}">${diffText(d)}</span>`:''}</small></div><span>${fmt(r.estimatedXph)} XP/h</span><span>${fmt(r.estimatedGoldph)} G/h</span><button class="go" data-go="${encodeURIComponent(r.name)}">${t('go')}</button></div>`}).join('')||t('noData');document.querySelectorAll('#allHunts [data-go]').forEach(b=>b.onclick=()=>go(decodeURIComponent(b.dataset.go)))}
...
function renderParty(){
 ...
 $('partyCards').innerHTML=rows.map(c=>{
...
const BOSS_STATIC_CATALOG=[{"name":"Shadowpelt","category":"archfoe","id":"shadowpelt"},{"name":"The Blazing Rose","category":"archfoe","id":"the_blazing_rose"},{"name":"Darkfang","category":"archfoe","id":"darkfang"},{"name":"Bloodback","category":"archfoe","id":"bloodback"},{"name":"The Lily of Night","category":"archfoe","id":"the_lily_of_night"},{"name":"The Diamond Blossom","category":"archfoe","id":"the_diamond_blossom"},{"name":"Black Vixen","category":"archfoe","id":"black_vixen"},{"name":"Sharpclaw","category":"archfoe","id":"sharpclaw"},{"name":"Leiden","category":"nemesis","id":"leiden"},{"name":"Utua Stone Sting","category":"archfoe","id":"utua_stone_sting"},{"name":"Brokul","category":"archfoe","id":"brokul"},{"name":"Amenef the Burning","category":"archfoe","id":"amenef_the_burning"},{"name":"Solid Frozen Horror","category":"nemesis","id":"solid_frozen_horror"},{"name":"Ahau","category":"archfoe","id":"ahau"},{"name":"Irgix The Flimsy","category":"archfoe","id":"irgix_the_flimsy"},{"name":"Unaz the Mean","category":"archfoe","id":"unaz_the_mean"},{"name":"Vok the Freakish","category":"archfoe","id":"vok_the_freakish"},{"name":"Tanjis","category":"bane","id":"tanjis"},{"name":"Kusuma","category":"archfoe","id":"kusuma"},{"name":"Brain Head","category":"archfoe","id":"brain_head"},{"name":"Neferi the Spy","category":"archfoe","id":"neferi_the_spy"},{"name":"Sister Hetai","category":"archfoe","id":"sister_hetai"},{"name":"Scarlett Etzel","category":"bane","id":"scarlett"},{"name":"The Time Guardian","category":"archfoe","id":"the_time_guardian"},{"name":"Dragonking Zyrtarch","category":"nemesis","id":"dragonking_zyrtarch"},{"name":"Lloyd","category":"archfoe","id":"lloyd"},{"name":"Mounted Thorn Knight","category":"nemesis","id":"mounted_thorn_knight"},{"name":"Foreshock","category":"nemesis","id":"foreshock"},{"name":"Sir Nictros","category":"archfoe","id":"sir_nictros"},{"name":"Urmahlullu the Weakened","category":"archfoe","id":"urmahlullu"},{"name":"Megasylvan Yselda","category":"archfoe","id":"megasylvan_yselda"},{"name":"Obujos","category":"bane","id":"obujos"},{"name":"Drume","category":"archfoe","id":"drume"},{"name":"Vladrukh","category":"archfoe","id":"vladrukh"},{"name":"Timira the Many-Headed","category":"archfoe","id":"timira_the_many_headed"},{"name":"Grand Master Oberon","category":"archfoe","id":"oberon"},{"name":"Ratmiral Blackwhiskers","category":"archfoe","id":"ratmiral"},{"name":"Faceless Bane","category":"archfoe","id":"faceless_bane"},{"name":"Lady Tenebris","category":"archfoe","id":"lady_tenebris"},{"name":"Duke Krule","category":"archfoe","id":"duke_krule"},{"name":"Rupture","category":"archfoe","id":"rupture"},{"name":"Anomaly","category":"archfoe","id":"anomaly"},{"name":"Ghulosh","category":"archfoe","id":"ghulosh"},{"name":"Lokathmor","category":"archfoe","id":"lokathmor"},{"name":"Mazzinor","category":"archfoe","id":"mazzinor"},{"name":"The Dread Maiden","category":"archfoe","id":"the_dread_maiden"},{"name":"Count Vlarkorth","category":"archfoe","id":"count_vlarkorth"},{"name":"The Brainstealer","category":"archfoe","id":"the_brainstealer"},{"name":"Earl Osam","category":"archfoe","id":"earl_osam"},{"name":"Lord Azaram","category":"archfoe","id":"lord_azaram"},{"name":"Alptramun","category":"nemesis","id":"alptramun"},{"name":"Jaul","category":"bane","id":"jaul"},{"name":"Shulgrax","category":"archfoe","id":"shulgrax"},{"name":"Dragon Pack","category":"archfoe","id":"dragon_pack"},{"name":"Court Warlock","category":"archfoe","id":"court_warlock"},{"name":"Outburst","category":"archfoe","id":"outburst"},{"name":"Razzagorn","category":"archfoe","id":"razzagorn"},{"name":"Tarbaz","category":"archfoe","id":"tarbaz"},{"name":"Arbaziloth","category":"archfoe","id":"arbaziloth"},{"name":"Gorzindel","category":"archfoe","id":"gorzindel"},{"name":"The Monster","category":"archfoe","id":"the_monster"},{"name":"Prince Drazzak","category":"archfoe","id":"prince_drazzak"},{"name":"Lord Retro","category":"archfoe","id":"lord_retro"},{"name":"Magma Bubble","category":"archfoe","id":"magma_bubble"},{"name":"Ragiaz","category":"archfoe","id":"ragiaz"},{"name":"Plagirath","category":"archfoe","id":"plagirath"},{"name":"Urmahlullu the Immaculate","category":"archfoe","id":"urmahlullu_the_immaculate"},{"name":"The Fear Feaster","category":"archfoe","id":"the_fear_feaster"},{"name":"The Unwelcome","category":"archfoe","id":"the_unwelcome"},{"name":"The Primal Menace","category":"archfoe","id":"the_primal_menace"},{"name":"The Pale Worm","category":"archfoe","id":"the_pale_worm"},{"name":"The Rootkraken","category":"archfoe","id":"the_rootkraken"},{"name":"Eradicator","category":"archfoe","id":"eradicator"},{"name":"World Devourer","category":"nemesis","id":"world_devourer"},{"name":"King Zelos","category":"archfoe","id":"king_zelos"},{"name":"The Scourge of Oblivion","category":"archfoe","id":"the_scourge_of_oblivion"},{"name":"Goshnar's Cruelty","category":"archfoe","id":"goshnar_s_cruelty"},{"name":"The Last Lore Keeper","category":"nemesis","id":"the_last_lore_keeper"},{"name":"Goshnar's Greed","category":"archfoe","id":"goshnar_s_greed"},{"name":"The Nightmare Beast","category":"nemesis","id":"the_nightmare_beast"},{"name":"Mitmah Vanguard","category":"archfoe","id":"mitmah_vanguard"},{"name":"Ichgahal","category":"archfoe","id":"ichgahal"},{"name":"Goshnar's Hatred","category":"archfoe","id":"goshnar_s_hatred"},{"name":"Goshnar's Malice","category":"archfoe","id":"goshnar_s_malice"},{"name":"Goshnar's Spite","category":"archfoe","id":"goshnar_s_spite"},{"name":"Bonelord's Phylactery","category":"nemesis","id":"bonelord_s_phylactery"},{"name":"Ferumbras Mortal Shell","category":"nemesis","id":"ferumbras_mortal_shell"},{"name":"Fatal Bug","category":"nemesis","id":"fatal_bug"},{"name":"The Gravedigger","category":"archfoe","id":"the_gravedigger"},{"name":"Ice Horror","category":"archfoe","id":"ice_horror"},{"name":"Eldritch Dragon Lord","category":"archfoe","id":"eldritch_dragon_lord"},{"name":"Chagorz","category":"archfoe","id":"chagorz"},{"name":"Murcion","category":"archfoe","id":"murcion"},{"name":"Vemiath","category":"archfoe","id":"vemiath"},{"name":"Goshnar's Megalomania","category":"nemesis","id":"goshnar_s_megalomania"},{"name":"Bakragore","category":"nemesis","id":"bakragore"}];
function bossCategoryLabel(v){return v==='bane'?'Bane':v==='nemesis'?'Nemesis':v==='archfoe'?'Archfoe':'Boss'}
...
function renderBosses(){
 ...
 const run=snap.run||{};
 $('bossCharges').textContent=compactBossCharges(snap.charges);$('bossQueueCount').textContent=bossQueue.length;$('bossDetectedCount').textContent=BOSS_STATIC_CATALOG.length;
 ...
 const q=norm($('bossSearch')?.value),f=$('bossFilter')?.value||'all';
 ...
 const rows=catalog.filter(b=>(!q||norm(b.name).includes(q))&&(f==='all'||(f==='ready'&&b.ready)||b.category===f));
 $('bossDetectedList').classList.toggle('empty',!rows.length);
 $('bossDetectedList').innerHTML=rows.map(b=>{const added=queueHas(b),warn=/level|nivel/i.test(b.status||''),image=b.image?`<img src="${esc(b.image)}" alt="${esc(b.name)}">`:`<span class="boss-image-placeholder">☠</span>`;return `<div class="boss-card ${b.ready?'ready':warn?'warning':'blocked'}" data-boss-key="${encodeURIComponent(bossKey(b))}"><button class="boss-card-select" data-boss-direct="${encodeURIComponent(bossKey(b))}" title="Seleccionar ${esc(b.name)}"><span class="boss-card-image">${image}</span><b>${esc(b.name)}</b><small>${bossCategoryLabel(b.category)}</small><em>${esc(b.status|| (b.ready?'Disponible':'Estado pendiente de comprobar'))}</em></button><button class="boss-add boss-card-add" data-boss-add="${encodeURIComponent(bossKey(b))}" ${added?'disabled':''} title="Agregar a la lista">${added?'✓':'+'}</button></div>`}).join('')||'No hay bosses con ese filtro.';
 ...
 $('bossQueueList').innerHTML=bossQueue.map((b,i)=>`<div class="boss-queue-item" draggable="true" data-queue-index="${i}"><span>${i+1}</span><div><b>${esc(b.name)}</b><small>${bossCategoryLabel(b.category)} · <em class="boss-result-${esc(b.status||'pending')}">${bossResultLabel(b.status)}</em></small></div><div class="queue-controls"><button class="boss-move" data-up="${i}" title="Subir">↑</button><button class="boss-move" data-down="${i}" title="Bajar">↓</button><button class="boss-remove" data-remove="${i}" title="Quitar">✕</button></div></div>`).join('')||'Agrega bosses desde el panel izquierdo.';
...
async function loadBosses(open=false){try{$('bossMessage').textContent=open?'Abriendo panel de bosses...':'Leyendo bosses...';const r=await message({type:open?'BAIAK_BOSS_OPEN':'BAIAK_BOSS_STATUS',force:open});if(!r.ok)throw Error(r.error);bossSnapshot=r.result;const st=await chrome.storage.local.get({bossOwnQueue:[]});bossQueue=Array.isArray(st.bossOwnQueue)?st.bossOwnQueue:[];if(Array.isArray(r.result.run?.queue)&&r.result.run.queue.length)bossQueue=r.result.run.queue;renderBosses();$('bossMessage').textContent=r.result.bosses?.length?'Bosses actualizados automáticamente.':'No se pudo cargar la lista de bosses.';}catch(e){$('bossMessage').textContent=e.message}}
...
document.querySelectorAll('.tabs button').forEach(b=>b.onclick=()=>{document.querySelectorAll('.tabs button').forEach(x=>x.classList.toggle('active',x===b));document.querySelectorAll('.page').forEach(p=>p.classList.toggle('active',p.id===b.dataset.tab));if(b.dataset.tab==='bosses')loadBosses(false)});
